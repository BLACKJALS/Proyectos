...
public class matrices {
	...
	double[][] ecuacionmat(double a, double b, double c, double d, double e, double f, double g, double h, double i) {
	...
	double[] ecuacionvec(double a,double b, double c) {
		double vec[]={a,b,c};
		return vec;
	}
	/****************************************************/
	...
	//Obtener incognitas
	void ecuaciones(double mat[][],double vec[]) {
